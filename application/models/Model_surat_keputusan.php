        ...
        $columns = array(
		    ...
		    array(
                ...
                'formatter' => function ($d) {
                    ...
                    <a class='btn-sm btn-info' href=".base_url('index.php/surat_keputusan/edit/'.$d)."><i class='fas fa-edit'></i></a>
                    <a class='btn-sm btn-danger' data-toggle='modal' data-target='#hapus_surat_keputusan' data-href=".base_url('index.php/surat_keputusan/hapus/'.$d)."><i class='fas fa-trash'></i></a>
                    </center>";
                }
            )
        );

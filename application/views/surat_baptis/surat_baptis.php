<?php
    $status_session = $this->session->status_query_surat_baptis;
    ...
    $this->session->mark_as_temp('status_query_surat_baptis', 1);
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fas fa-file"></i> Surat Baptis</h1>
    </div>
</div>

<div class="row">
    <div class="col-lg-12">
        <a href="<?php echo base_url('index.php/surat_baptis/tambah'); ?>" class="btn btn-primary" ><i class="fas fa-file"></i> Tambah</a>
    </div>
</div>
    ...
    <table id="example" class="display table table-bordered table-hover table-striped" style="width:100%">
        <thead>
            <tr>
                ...
                <th style="text-align:center;">Tanggal Baptis</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo base_url('index.php/surat_baptis/ambil_surat_baptis'); ?>",
            "columnDefs": [
                { "width": "15%", "targets": [3] }
            ]
        });
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Detail Surat Baptis</h4>
            </div>
...
<div class="modal fade" id="hapus_surat_baptis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <b>Anda yakin ingin menghapus data surat baptis ini ?</b><br><br>
...
<script>
    $('#hapus_surat_baptis').on('show.bs.modal', function(e) {
    ...
    $('#show_detail').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : '<?php echo base_url('index.php/surat_baptis/detail'); ?>',
            data :  'rowid1='+ rowid1,

<?php
    $status_session = $this->session->status_query_surat_nikah;
    ...
    $this->session->mark_as_temp('status_query_surat_nikah', 1);

    $status_session_update = $this->session->status_query_sn_update;
    ...
    $this->session->mark_as_temp('status_query_sn_update', 1);

    $status_session_hapus = $this->session->status_query_sn_hapus;
    ...
    $this->session->mark_as_temp('status_query_sn_hapus', 1);
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fas fa-file"></i> Surat Nikah</h1>
    </div>
</div>

<div class="row">
    <div class="col-lg-12">
        <a href="<?php echo base_url('index.php/surat_nikah/tambah'); ?>" class="btn btn-primary" ><i class="fas fa-file"></i> Tambah</a>
    </div>
</div>
    ...
    <table id="example" class="display table table-bordered table-hover table-striped" style="width:100%">
        <thead>
            <tr>
                ...
                <th style="text-align:center;">Nama Pria</th>
                <th style="text-align:center;">Nama Wanita</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo base_url('index.php/surat_nikah/ambil_surat_nikah'); ?>",
            "columnDefs": [
                { "width": "15%", "targets": [4] }
            ]
        });
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Detail Surat Nikah</h4>
            </div>
...
<div class="modal fade" id="hapus_surat_nikah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <b>Anda yakin ingin menghapus data surat nikah ini ?</b><br><br>
...
<script>
    $('#hapus_surat_nikah').on('show.bs.modal', function(e) {
    ...
    $('#show_detail').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : '<?php echo base_url('index.php/surat_nikah/detail'); ?>',
            data :  'rowid1='+ rowid1,
